...
module globals
    ...
    integer,parameter:: xmax = 1023 !ｘ方向格子数（０から数える）
    integer,parameter:: ymax = 1023 !ｙ方向格子数（０から数える）
    integer,parameter:: zmax = 1023 !ｚ方向格子数（０から数える）
    !並行して計算する数
    ...
    character(*),parameter :: datadir = "/data/sht/nakanog/fft_test/"
    character(*),parameter :: datadir2 = "/data/sht/nakanog/fft_test/fg/"

    !無次元数
    real(8),parameter:: We = 3.0d0 !粒子ウエーバー数
    real(8),parameter:: Re = 150000.0d0 !粒子レイノルズ数
    ...
    real(8),parameter:: D_vortex = 511.5d0 !渦の大きさ
