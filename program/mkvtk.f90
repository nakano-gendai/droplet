module globals
    ...
    !読み込みディレクトリー
    character(*),parameter :: dir = "/data/lng/nakanog/taylor_512_re100000_large_xy/eddy/collect/"
    ! character(*),parameter :: dir = "./"
    !出力ディレクトリー
    character(*),parameter :: datadir = "/data/lng/nakanog/taylor_512_re100000_large_xy/eddy/collect/vtk/"
