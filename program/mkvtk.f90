module globals
    ...
    !読み込みディレクトリー
    character(*),parameter :: dir = "/data/sht/nakanog/DNS_turbulence_256_IHT/case6/collect/"
    ! character(*),parameter :: dir = "./"
    !出力ディレクトリー
    character(*),parameter :: datadir = "/data/sht/nakanog/DNS_turbulence_256_IHT/case6/collect/vtk/"
