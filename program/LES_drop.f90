...
module globals
    ...
    integer,parameter:: step_input_file_num = 1400000 !入力する乱流場のstep
    !出力ディレクトリ
    ! character(*),parameter :: datadir = "/data/n/n517/omp/"
    ! character(*),parameter :: datadir2 = "/data/n/n517/omp/fg/"
    character(*),parameter :: datadir_input = "/data/sht/nakanog/LES_turbulence_256_re80000_delta16/fg/"
    character(*),parameter :: datadir = "/data/sht/nakanog/LES_small_256_re80000_delta16_2/"
    character(*),parameter :: datadir2 = "/data/sht/nakanog/LES_small_256_re80000_delta16_2/fg/"
