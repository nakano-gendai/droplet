...
use globals
    ...
    character(*),parameter :: datadir = "/data/sht/nakanog/DNS_turbulence_256_IHT/70_case6/"
    character(*),parameter :: datadir2 = "/data/sht/nakanog/DNS_turbulence_256_IHT/70_case6/collect/"
