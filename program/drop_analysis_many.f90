...
module globals
    ...
    integer,parameter:: case_initial_num = 32 !最初のケース番号
    integer,parameter:: case_end_num = case_initial_num !最後のケース番号

    !読み込みディレクトリ
    character(*),parameter :: datadir_input = "/data/sht/nakanog/IHT_drop_d70_we20/"
    character(*),parameter :: datadir_input2 = "/data/sht/nakanog/IHT_drop_d70_we20/u/"
    !出力ディレクトリ
    character(*),parameter :: datadir_output = "/data/sht/nakanog/IHT_drop_d70_we20/contribution/"
    ...
    !無次元数
    real(8),parameter:: We = 20.0d0 !粒子ウエーバー数
