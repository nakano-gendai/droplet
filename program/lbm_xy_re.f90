...
module globals
    ...
    !時間に関するパラメータ
    integer,parameter:: step_start = 10000000
    integer,parameter:: step = 20000000 !計算時間step
    !入力ディレクトリ
    character(*),parameter :: datadir_input = "/data/lng/nakanog/taylor_512_re100000_large_xy/fg/"
    !出力ディレクトリ
    character(*),parameter :: datadir = "/data/lng/nakanog/taylor_512_re100000_large_xy/"
...
contains
    ...
    subroutine ini(g_procs,gnext_procs,geq_procs,p_procs,u1_procs,u2_procs,u3_procs,grad_u_procs,forcex,forcey,forcez,strain_procs,nue,taug_procs)
    ...
    !===============================================================================================================
        ...
        do zi=1,zmax+1
            do yi=1,y_procs
                do xi=1,x_procs
                    do i=1,15
                        read(99) g_procs(i,xi,yi,zi)
                    enddo
                enddo
            enddo
        enddo
        close(99)
        call physics_restart(p_procs, u1_procs, u2_procs, u3_procs,  g_procs, taug_procs, strain_procs, grad_u_procs, nue)
    end subroutine ini

    subroutine physics_restart(p_procs,u1_procs,u2_procs,u3_procs,g_procs,taug_procs,strain_procs,grad_u_procs,nue)
        ...
        !$omp end do
        !$omp end parallel
    end subroutine physics_restart
...
!!!!!!!!!!!!!!!!!!!!!!!!!!設定!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    call ini(g_procs,gnext_procs,geq_procs,p_procs,u1_procs,u2_procs,u3_procs,grad_u_procs,forcex,forcey,forcez,strain_procs,nue,taug_procs)
