...
implicit none
    ...
    character(*),parameter :: datadir_input = "/data/sht/nakanog/IHT_drop_d70_we5/contribution/"
    character(*),parameter :: datadir_output = "/data/sht/nakanog/IHT_drop_d70_we5/contribution/ave/"
