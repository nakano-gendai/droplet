...
module globals
    ...
    !時間に関するパラメータ
    integer,parameter:: step_start = 756000
    ...
    character(*),parameter :: datadir = "/data/sht/nakanog/LES2/"
    character(*),parameter :: datadir2 = "/data/sht/nakanog/LES2/fg/"

    !LESパラメータ
    real(8),parameter:: delta = 16.0d0*ds
...
contains
    ...
    subroutine ini(g_procs,gnext_procs,f_procs,fnext_procs,feq_procs,geq_procs,phi_procs,p_procs,u1_procs,u2_procs,u3_procs,grad_phi_procs,gphi_procs,lap_phi_procs,p0_procs,grad_u_procs,forcex,forcey,forcez,taug_procs,nu_procs,strain_procs,nue)
    ...
    !===============================================================================================================
        ...
        enddo
        close(99)
        call physics_restart(phi_procs, p_procs, u1_procs, u2_procs, u3_procs, f_procs, g_procs, nu_procs, taug_procs,strain_procs,grad_u_procs,nue)
    end subroutine ini

    subroutine physics_restart(phi_procs,p_procs,u1_procs,u2_procs,u3_procs,f_procs,g_procs,nu_procs,taug_procs,strain_procs,grad_u_procs,nue)
...
!================================初期条件・配列のallocate======================================
    ...
    call ini(g_procs,gnext_procs,f_procs,fnext_procs,feq_procs,geq_procs,phi_procs,p_procs,u1_procs,u2_procs,u3_procs,grad_phi_procs,gphi_procs,lap_phi_procs,p0_procs,grad_u_procs,forcex,forcey,forcez,taug_procs,nu_procs,strain_procs,nue)
...
!================================出力==================================
    ...
    if(comm_rank == 0) then
        if(mod(n,100)==0) then
            if(n == 2024100) then
                open(10,file="./retime.d")
                write(10,*) n, time2-time1, u1_procs(1,1,1)
                close(10)
            else
                open(10,file="./retime.d",action="write",position="append")
                write(10,*) n, time2-time1, u1_procs(1,1,1)
                close(10)
            endif
        endif
