...
module globals
    ...
    !時間に関するパラメータ
    integer,parameter:: step_start = 100000 !計算開始step
    integer,parameter:: step = 120000 !計算時間step
    !出力ディレクトリ
    character(*),parameter :: datadir = "/data/sht/nakanog/DNS_medium_256_re80000/"
    character(*),parameter :: datadir2 = "/data/sht/nakanog/DNS_medium_256_re80000/fg/"
    ...
    real(8),parameter:: sigma = 1.96d-5 !界面張力
...
contains
    ...
    subroutine ini(g_procs,gnext_procs,f_procs,fnext_procs,feq_procs,geq_procs,phi_procs,p_procs,u1_procs,u2_procs,u3_procs,grad_phi_procs,gphi_procs,lap_phi_procs,p0_procs,grad_u_procs,forcex,forcey,forcez,taug_procs,nu_procs)
    ...
    !===============================================================================================================
        ...
        enddo
        close(99)
        call physics_restart(phi_procs, p_procs, u1_procs, u2_procs, u3_procs, f_procs, g_procs, nu_procs, taug_procs)
    end subroutine ini

    subroutine physics_restart(phi_procs,p_procs,u1_procs,u2_procs,u3_procs,f_procs,g_procs,nu_procs,taug_procs)
...
!================================初期条件・配列のallocate======================================
    ...
    call ini(g_procs,gnext_procs,f_procs,fnext_procs,feq_procs,geq_procs,phi_procs,p_procs,u1_procs,u2_procs,u3_procs,grad_phi_procs,gphi_procs,lap_phi_procs,p0_procs,grad_u_procs,forcex,forcey,forcez,taug_procs,nu_procs)
...
!================================出力==================================
    ...
    !         if(n == 4000) then
    !             open(11,file="./kinetic_512.d")
    !             write(11,*) dble(n), dble(n)*umax/D_vortex, kinetic_ave
    !             close(11)
    !         else
    !             open(11,file="./kinetic_512.d",action="write",position="append")
    !             write(11,*) dble(n), dble(n)*umax/D_vortex, kinetic_ave
    !             close(11)
    !         endif
    !     endif
