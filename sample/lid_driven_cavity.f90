...
subroutine rhouvf(f,rho,u,v,cx,cy,n,m)
...
subroutine result(u,v,rho,u0,n,m)
real u(0:n,0:m),v(0:n,0:m)
real rho(0:n,0:m), strf(0:n,0:m)
open(5,file='streamf')
!streamfuction calculation
strf(0,0)=0
do i=0,n
