...
implicit none
    ...
    real(8),parameter :: epsilon = 9.15d-10
    real(8),parameter :: D = 70.0d0
    real(8),parameter :: td = epsilon**(-1.0d0/3.0d0)*D**(2.0d0/3.0d0)
    real(8),parameter :: sigma = 5.6d-4
    real(8),parameter :: Dh = 0.725d0*epsilon**(-2.0d0/5.0d0)*sigma**(3.0d0/5.0d0)
    real(8),parameter :: th = epsilon**(-1.0d0/3.0d0)*Dh**(2.0d0/3.0d0)
    ...
    ! open(10,file="d70we2_break_time.d")
    ! do i = 1, num
    !     read(10,*) dummy4, f(i)
    ! enddo
    ! close(10)
