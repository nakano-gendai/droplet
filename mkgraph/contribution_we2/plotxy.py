...
dfile3   = datadir + 'd70we2_break_time.d'
...
# x11 = np.loadtxt(dfile2, usecols = 0, dtype = 'float64') # usecolsは列番号　dtypeは実数float64, 整数
# x22 = np.loadtxt(dfile2, usecols = 0, dtype = 'float64') # usecolsは列番号　dtypeは実数float64, 整数
# x33 = np.loadtxt(dfile2, usecols = 0, dtype = 'float64') # usecolsは列番号　dtypeは実数float64, 整数
# x44 = np.loadtxt(dfile2, usecols = 0, dtype = 'float64') # usecolsは列番号　dtypeは実数float64, 整数
# x55 = np.loadtxt(dfile2, usecols = 0, dtype = 'float64') # usecolsは列番号　dtypeは実数float64, 整数
# x66 = np.loadtxt(dfile2, usecols = 0, dtype = 'float64') # usecolsは列番号　dtypeは実数float64, 整数
# x77 = np.loadtxt(dfile2, usecols = 0, dtype = 'float64') # usecolsは列番号　dtypeは実数float64, 整数
# x88 = np.loadtxt(dfile2, usecols = 0, dtype = 'float64') # usecolsは列番号　dtypeは実数float64, 整数
...
# y11 = np.loadtxt(dfile2, usecols = 1, dtype = 'float64')
# y22 = np.loadtxt(dfile2, usecols = 2, dtype = 'float64')
# y33 = np.loadtxt(dfile2, usecols = 3, dtype = 'float64')
# y44 = np.loadtxt(dfile2, usecols = 4, dtype = 'float64')
# y55 = np.loadtxt(dfile2, usecols = 5, dtype = 'float64')
# y66 = np.loadtxt(dfile2, usecols = 6, dtype = 'float64')
# y77 = np.loadtxt(dfile2, usecols = 7, dtype = 'float64')
# y88 = np.loadtxt(dfile2, usecols = 8, dtype = 'float64')

# ytext = np.loadtxt(dfile3, usecols = 1, dtype = 'float64')
...
def plot_y1y2(i): # y1, y2プロット用
    ...
    # xm, ym = [0, 2.6], [-0.000000000005, 0.00000000003]
    xm, ym = [0, 4], [-0.00000000002, 0.00000000004]
    ...
    if ytext[i-1]>0 :
        ax1.axvline(ytext[i-1], lw = lw1*1.0, ls = 'dashed', dashes = [1, 2], color = 'gray') # dashesで破線の間隔などを設定できる
    # ytext = -22.
    ...
    # ### 保存
    fig.savefig(plotdir + name + ext, bbox_inches = "tight") # bbox_inches="tight"で余白をなくす
