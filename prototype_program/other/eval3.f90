module globals
    ...
    ! character(*),parameter :: dir = "/home/nakano/anime/b4/eta=1.0/Re=0.2/data_ca0.1/"
    character(*),parameter :: dir = "/data/n/n517/fromini/gnu_3/"
...
contains
    subroutine senkei(xx1,xx2,zz1,zz2,xxg,zzg,L1,B1,phi)
        ...
        real, intent(in) :: phi(0:xmax, 0:ymax, 0:zmax)
        real(8) distance
        real(8) alpha, l
        real(8) xj, zj
...
use globals
    ...
    open(10,file="ini_re0.2ca0.4.d")
DO step = 3000, num, 1000
    ...
    Dd = abs(L1-B1) / (L1+B1)
    !出力
    write(10,"(4es24.16)") (dble(step)-dble(5000))*2.0d0*uw/dble(zmax),L1,B1,Dd
