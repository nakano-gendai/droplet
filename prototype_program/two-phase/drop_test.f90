module globals
    ...
    real(8),parameter:: nu1 = 0.064d0 !液体の動粘度
    real(8),parameter:: nu2 = 0.064d0 !液滴の動粘度
    real(8),parameter:: uw = 0.005d0 !壁の移動速度
    real(8),parameter:: kappaf = 0.01d0*ds**2 !界面厚さを決めるパラメータ
    real(8),parameter:: kappag = 1.6d-3 !界面張力を決めるパラメータ
...
!===========================液滴分裂========================================================
    if(comm_rank == 0) then
        ...
        write(10,"(5es16.8)") dble(n), (dble(n)-dble(start))*2.0d0*uw/H1, u1(4,4,96)/uw, u2(4,4,96)/uw, u3(4,4,96)/uw
    endif
    ! endif
    ! if(comm_rank == 0) then
    !     write(*,*) "step = ",n
