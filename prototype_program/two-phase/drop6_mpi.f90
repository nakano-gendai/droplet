module globals
    ...
    integer,parameter:: start = 10000 !壁を動かし始める時間step
    ...
    character(*),parameter :: datadir = "/data/2022/nakano/data_ca0.4_2/"
    ...
    real(8),parameter:: nu2 = 0.8d0 !液滴の動粘度
    real(8),parameter:: uw = 4.0d-2 !壁の移動速度
...
contains
    ...
    subroutine break_up2(phi,p)
        real(8),intent(in):: phi(-1:xmax+1,-1:ymax+1,-1:zmax+1), p(0:xmax,0:ymax,0:zmax)
        !重心座標を計算
        xg = 0.0d0
        yg = 0.0d0
        zg = 0.0d0
        ...
        if(n <= start) then
            ...
            do zi=0,zmax
                ...
                enddo
            enddo
            write(8,"(8es16.8)") dble(n),dp_cal,sigma,kappag_tmp,wa
        endif
