module globals
    ...
    integer,parameter:: step = 300000 !計算時間step
    ...
    character(*),parameter :: datadir = "/data/2022/nakano/data_re=1.0_ca=0.25/"
    ...
    real(8),parameter:: nu1 = 0.16d0 !液体の動粘度
    real(8),parameter:: nu2 = 0.16d0 !液滴の動粘度
    real(8),parameter:: uw = 0.04d0 !壁の移動速度
    real(8),parameter:: kappaf = 0.01d0*ds**2 !界面厚さを決めるパラメータ
    real(8),parameter:: kappag = 3.63d-3 !界面張力を決めるパラメータ
