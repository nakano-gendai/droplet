module globals
    ...
    integer,parameter:: xmax = 96 !ｘ方向格子数
    integer,parameter:: ymax = 96 !ｙ方向格子数
    integer,parameter:: zmax = 96 !ｚ方向格子数
    integer,parameter:: step = 500000 !計算時間step
    integer,parameter:: start = 500000 !壁を動かす時間step
    integer,parameter:: kappag_start = 10000 !界面張力をかけ始めるstep
    integer,parameter:: kappag_end = 30000 !界面張力をかけ終わるstep
